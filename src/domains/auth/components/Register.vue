  ...
  <div class="col-md-4 col-md-offset-4 col-sm-6 col-sm-offset-3">
    <div class="card card-signup">
      <form class="form" @submit.prevent=" login " style="padding: 10px;">
        <div class="header header-primary text-center fadeInDown animated" data-background-color="blue">
          <h4>Cadastrar-se</h4>
        ...
        <div class="content" >
          <div class="input-group">
            ...
            <div class="form-group is-empty">
              <input v-model="user.name" type="text" class="form-control" placeholder="Nome completo" required>
          ...
          <div class="checkbox">
            <label>
              <input v-model="user.terms" type="checkbox" name="terms" required>
              Terms
            </label>
          </div>
        </div>
        <div class="footer text-center" style="padding: 15px 0px 15px 0px">
          <button type="submit" v-if="!loading" class="btn btn-default btn-round transition">
            Entrar
          ...
          <router-link class="btn btn-simple" :to="{ name: 'AUTH.LOGIN' }">Fazer Login</router-link>
        </div>
      </form>
    </div>
  </div>
